        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            ...
            <div className="flex mb-4">
              <a className="flex-grow text-indigo-200 border-b-2 border-indigo-500 py-2 text-lg px-1">
                Description
              </a>
            </div>
            ...
            <ul className="mb-4 list-disc pl-4">
              {Course.features &&
                Course.features.split("\n").map((feature) => (
                  <li className="text-white" key={Math.random()}>
                    {feature}
                  </li>
                ))}
            </ul>
            ...
            <div className="flex">
              ...
              UMCState.userDetails.enrolledCourse.indexOf(courseId) !== -1 ? (
                <p className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
                  <Link
                    onClick={saveCurrentCourse}
                    to={`/courses/play/${courseId}`}
                  >
                    Start
                  </Link>
                </p>
