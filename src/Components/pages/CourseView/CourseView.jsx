...
function CourseView() {
    ...
    return (
        <section className="text-gray-400 bg-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                        ...
                        <p className="leading-relaxed mb-4 text-white">{Course.courseDetails}</p>
                        <div className="flex mb-4">
                    ...
                    <div className="lg:w-1/2 w-full lg:h-auto h-64 lg:mt-8">
                        <iframe className="w-full h-2/3" src="https://www.youtube.com/embed/-bt_y4Loofg?autoplay=0&fs=1&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                    </div>
