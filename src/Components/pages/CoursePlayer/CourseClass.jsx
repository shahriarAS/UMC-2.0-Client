...
function CourseClass() {
  ...
  const grabEnrolledCourse = () => {
    axios
      .get(
        `${process.env.REACT_APP_API_DOMAIN}/course/viewenrolled/${courseId}`,
        {
          headers: {
  ...
  return sectionLoading ? (
    ...
    <>
      <div className="bgNeed min-h-screen h-full">
        <h1 className="font-bold text-xl py-2 border-b text-center text-white">
          {Course.title}
        </h1>
        <div className="flex">
          <div
            ...
            } bg-gray-800 whitespace-nowrap md:w-60 z-50 md:static overflow-hidden transition-all duration-300 ${
              sidebarOpen ? "p-4" : "p-0"
            } md:p-4 h-full absolute`}
          >
                            ...
                            {chapter.classes
                              ...
                              .map((classItem) => (
                                <li
                                  ...
                                  className="cursor-pointer font-bold border-2 border-white text-center my-2 hover:bg-white hover:text-black transition-all"
                                >
                                  {classItem.title}
                                </li>
                              ))}
          ...
          <div className="w-full min-h-screen">
            ...
            <div className="w-full min-h-screen flex flex-col md:flex-row">
              <div className="md:w-2/3 w-full mt-2 md:p-4 h-full ">
                <EmbdedPlayer
                  classTitle={
                    ClassData.title ? ClassData.title : "Class Title Here"
                  }
                  videoLink={ClassData.videoLink}
                />
                <div className="w-full rounded bg-gray-200 mt-2 mb-4 p-4 whitespace-normal">
              ...
              <div className="md:w-1/3 w-full md:h-60 mt-2 md:p-4 min-h-screen p-4">
                ...
                <Link
                  to={`/courses/view/${Course._id}/pdf`}
                  target="_blank"
                  className="hover:text-red-800 hover:font-bold"
                >
                  <p className="hover:bg-white hover:text-black transition-all duration-150 border list-none  rounded-sm px-3 py-3 mb-2 text-white text-center">
                    Full Course PDF
                  </p>
                </Link>
                <div>
                  <p className="text-lg font-bold mb-2 text-white">PDF OF This Class</p>
                  <ul className="px-0">
                    {ClassData.pdfs &&
                      ClassData.pdfs.map((pdf) => (
                        <a
                          ...
                          className="hover:text-red-800 hover:font-bold"
                        >
                          <li className="hover:bg-white hover:text-black transition-all duration-150 border list-none  rounded-sm px-3 py-3 mb-2 text-white">
                            {pdf.title}
                          </li>
                        </a>
                      ))}
